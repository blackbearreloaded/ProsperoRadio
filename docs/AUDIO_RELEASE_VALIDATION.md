...
channels. ProsperoRadio keeps the hardware AAC path and safely normalizes mono output
...
and enlarged diagnostic buffer were removed; ProsperoRadio retains its two-second
PCM queue and one-second startup reserve.

## Release conclusion

All formats advertised by ProsperoRadio have a working PS5 path and bounded failure
