...
ProsperoRadio uses the console-provided `libSceOpusDec` and `libSceOpusCeltDec`
...
| 2026-08-25 | 6.02 | `PPSA99612` integration | The production ProsperoRadio eboot entered normally, rendered `v0.2.0`, refreshed six catalog feeds, admitted 13 explicitly identified Opus stations, and closed with runtime layers released. |
